...
def launch_interface(settings: dict) -> None:
    """
    Launch a kernel interface blocking until it has closed.

    Notes:
        - Available in CPython.
        - 'interface_class' can be specified in settings as a subclass of [BaseInterface][async_kernel.interface.base.BaseInterface]  or as an importable string.
