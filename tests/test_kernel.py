...
async def test_subshell(client: AsyncKernelClient, kernel: Kernel):
    ...
    assert repr(kernel.main_shell) == "<AsyncInteractiveShell  kernel name: 'async'>"
    assert repr(subshell) == f"<AsyncInteractiveSubshell kernel name: 'async'  subshell id: {subshell_id}>"
