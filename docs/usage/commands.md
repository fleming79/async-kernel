...
The type of backend can be specified at the attribute [interface.backend][async_kernel.interface.base.Interface.backend].
The backend_options can be specified at the attribute [interface.backend_options][async_kernel.interface.base.Interface.backend_options].
